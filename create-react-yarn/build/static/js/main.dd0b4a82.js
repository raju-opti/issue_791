...
var config_1 = __webpack_require__(679);
...
var browserRequest_1 = __webpack_require__(351);
var httpPollingDatafileManager_1 = __importDefault(__webpack_require__(467));
...
var config_1 = __webpack_require__(679);
var js_sdk_logging_1 = __webpack_require__(949);
...
var js_sdk_logging_1 = __webpack_require__(949);
var js_sdk_utils_1 = __webpack_require__(888);
var eventEmitter_1 = __importDefault(__webpack_require__(737));
var config_1 = __webpack_require__(679);
var backoffController_1 = __importDefault(__webpack_require__(760));
var logger = js_sdk_logging_1.getLogger('DatafileManager');
...
var browserDatafileManager_1 = __webpack_require__(216);
...
var eventQueue_1 = __webpack_require__(464);
var js_sdk_logging_1 = __webpack_require__(949);
var js_sdk_utils_1 = __webpack_require__(888);
 ...
 */
var js_sdk_logging_1 = __webpack_require__(949);
var pendingEventsStore_1 = __webpack_require__(400);
var js_sdk_utils_1 = __webpack_require__(888);
var logger = js_sdk_logging_1.getLogger('EventProcessor');
 ...
 */
var js_sdk_logging_1 = __webpack_require__(949);
var eventProcessor_1 = __webpack_require__(710);
var requestTracker_1 = __importDefault(__webpack_require__(614));
var events_1 = __webpack_require__(528);
var buildEventV1_1 = __webpack_require__(247);
 ...
 * limitations under the License.
 */
var errorHandler_1 = __webpack_require__(370);
var js_sdk_utils_1 = __webpack_require__(888);
var models_1 = __webpack_require__(46);
 ...
 * limitations under the License.
 */
var uuid_1 = __webpack_require__(893);
...
var v1 = __webpack_require__(875);
var v4 = __webpack_require__(899);
var uuid = v4;
uuid.v1 = v1;
uuid.v4 = v4;
module.exports = uuid;
...
var bytesToUuid = __webpack_require__(542);
...
var t = __webpack_require__(949),
  r = __webpack_require__(450),
  i = e(__webpack_require__(571)),
  n = e(__webpack_require__(971)),
  o = __webpack_require__(581),
  _a = function a() {
...
function s() {
  ...
  var i = Array(e),
    n = 0;
  for (t = 0; t < r; t++) for (var o = arguments[t], a = 0, s = o.length; a < s; a++, n++) i[n] = o[a];
  return i;
}
var u = Math.pow(2, 53);
function l(e) {
...
var g,
  p = {
    ...
    isSafeInteger: function isSafeInteger(e) {
      return "number" == typeof e && Math.abs(e) <= u;
    },
    keyBy: E,
    uuid: function uuid() {
      return i();
    ...
    isValidEnum: function isValidEnum(e, t) {
      for (var r = !1, i = Object.keys(e), n = 0; n < i.length; n++) if (t === e[i[n]]) {
        r = !0;
        break;
      }
      return r;
  ...
  V = function V(e) {
    if ("object" == typeof e && null !== e) {
      var t = e,
        ...
        i = t.eventDispatcher,
        n = t.logger;
      if (r && "function" != typeof r.handleError) throw new Error(f(N.INVALID_ERROR_HANDLER, S));
      if (i && "function" != typeof i.dispatchEvent) throw new Error(f(N.INVALID_EVENT_DISPATCHER, S));
      if (n && "function" != typeof n.log) throw new Error(f(N.INVALID_LOGGER, S));
      return !0;
    }
    throw new Error(f(N.INVALID_CONFIG, S));
  },
  C = function C(e) {
    if (!e) throw new Error(f(N.NO_DATAFILE_SPECIFIED, S));
    if ("string" == typeof e) try {
      e = JSON.parse(e);
    } catch (e) {
      throw new Error(f(N.INVALID_DATAFILE_MALFORMED, S));
    }
    if ("object" == typeof e && !Array.isArray(e) && null !== e && -1 === m.indexOf(e.version)) throw new Error(f(N.INVALID_DATAFILE_VERSION, S, e.version));
    return e;
  };
var F = {
  ...
  P = {
    dispatchEvent: function dispatchEvent(e, t) {
      ...
      }, r.send(JSON.stringify(i))) : (n += "?wxhr=true", i && (n += "&" + M(i)), (r = new XMLHttpRequest()).open("GET", n, !0), r.onreadystatechange = function () {
        if (4 === r.readyState && t && "function" == typeof t) try {
          t({
            statusCode: r.status
          });
...
}(x || (x = {})), (k = exports.N1 || (exports.N1 = {})).DISABLE_DECISION_EVENT = "DISABLE_DECISION_EVENT", k.ENABLED_FLAGS_ONLY = "ENABLED_FLAGS_ONLY", k.IGNORE_USER_PROFILE_SERVICE = "IGNORE_USER_PROFILE_SERVICE", k.INCLUDE_REASONS = "INCLUDE_REASONS", k.EXCLUDE_VARIABLES = "EXCLUDE_VARIABLES";
var w = function () {
    function e(e) {
      var t,
        r = e.optimizely,
    ...
    return e.prototype.setAttribute = function (e, t) {
      ...
      var r,
        i = e.flagKey,
        n = null !== (r = e.ruleKey) && void 0 !== r ? r : v.FORCED_DECISION_NULL_RULE_KEY,
        o = {
      ...
      var t,
        r = null !== (t = e.ruleKey) && void 0 !== t ? t : v.FORCED_DECISION_NULL_RULE_KEY,
        i = e.flagKey,
        n = !1;
...
function Y(e, t) {
  if (Array.isArray(e)) {
    var r = e[0],
      i = e.slice(1);
    switch ("string" == typeof r && -1 === j.indexOf(r) && (r = "or", i = e), r) {
      case "and":
        return function (e, t) {
          var r = !1;
          if (Array.isArray(e)) {
  ...
  return e.prototype.getDatafile = function () {
    ...
    if (t) {
      ...
      t.forEach(function (t) {
        var o = "";
        if (t instanceof Array) o = "(" + (o = e.getSerializedAudiences(t, r)) + ")";else if (j.indexOf(t) > -1) n = t.toUpperCase();else {
...
var z = function z(e, t) {
    ...
    var r,
      ...
      n,
      o,
      a = ((o = l({}, r = e)).audiences = (r.audiences || []).map(function (e) {
        return l({}, e);
      ...
      }), o.environmentKey = null !== (i = r.environmentKey) && void 0 !== i ? i : "", o.sdkKey = null !== (n = r.sdkKey) && void 0 !== n ? n : "", o);
    return a.__datafileStr = null === t ? JSON.stringify(e) : t, (a.audiences || []).forEach(function (e) {
      e.conditions = JSON.parse(e.conditions);
    }), a.audiencesById = E(a.audiences, "id"), l(a.audiencesById, E(a.typedAudiences, "id")), a.attributeKeyMap = E(a.attributes, "key"), a.eventKeyMap = E(a.events, "key"), a.groupIdMap = E(a.groups, "id"), Object.keys(a.groupIdMap || {}).forEach(function (e) {
      (a.groupIdMap[e].experiments || []).forEach(function (t) {
        a.experiments.push(l(t, {
          groupId: e
        }));
      });
    }), a.rolloutIdMap = E(a.rollouts || [], "id"), I(a.rolloutIdMap || {}).forEach(function (e) {
      (e.experiments || []).forEach(function (e) {
        a.experiments.push(e), e.variationKeyMap = E(e.variations, "key");
      });
    }), a.experimentKeyMap = E(a.experiments, "key"), a.experimentIdMap = E(a.experiments, "id"), a.variationIdMap = {}, a.variationVariableUsageMap = {}, (a.experiments || []).forEach(function (e) {
      e.variationKeyMap = E(e.variations, "key"), l(a.variationIdMap, E(e.variations, "id")), I(e.variationKeyMap || {}).forEach(function (e) {
        e.variables && (a.variationVariableUsageMap[e.id] = E(e.variables, "id"));
      });
    }), a.experimentFeatureMap = {}, a.featureKeyMap = E(a.featureFlags || [], "key"), I(a.featureKeyMap || {}).forEach(function (e) {
      e.variables.forEach(function (e) {
        e.type === y.STRING && e.subType === y.JSON && (e.type = y.JSON, delete e.subType);
      }), e.variableKeyMap = E(e.variables, "key"), (e.experimentIds || []).forEach(function (t) {
    ...
    }), a.flagVariationsMap = {}, c(a.flagRulesMap || {}).forEach(function (e) {
      var t = e[0],
        r = e[1],
        i = [];
      ...
      }), a.flagVariationsMap[t] = i;
    }), a;
  },
  J = function J(e, t) {
    var r = e.experimentIdMap[t];
    if (!r) throw new Error(f(N.INVALID_EXPERIMENT_ID, X, t));
    return r.layerId;
  },
  Z = function Z(e, t, r) {
    var i = e.attributeKeyMap[t],
      n = 0 === t.indexOf("$opt_");
    return i ? (n && r.log(O.WARNING, "Attribute %s unexpectedly has reserved prefix %s; using attribute ID instead of reserved attribute name.", t, "$opt_"), i.id) : n ? t : (r.log(O.DEBUG, N.UNRECOGNIZED_ATTRIBUTE, X, t), null);
  },
  W = function W(e, t) {
  ...
  q = function q(e, t) {
    ...
    if (!r) throw new Error(f(N.INVALID_EXPERIMENT_KEY, X, t));
    return r.status;
  },
  $ = function $(e, t) {
  ...
  Q = function Q(e, t) {
    ...
    throw new Error(f(N.EXPERIMENT_KEY_NOT_IN_DATAFILE, X, t));
  },
  ee = function ee(e, t) {
    var r = e.experimentIdMap[t];
    if (!r) throw new Error(f(N.INVALID_EXPERIMENT_ID, X, t));
  ...
  re = function re(e, t, r) {
    if (!e) return null;
    var i = _(e.flagVariationsMap[t], function (e) {
      return e.key === r;
    });
    return i || null;
  },
  ...
  oe = function oe(e) {
    ...
    if (e.jsonSchemaValidator) try {
      e.jsonSchemaValidator.validate(t), e.logger.log(O.INFO, R.VALID_DATAFILE, X);
    } catch (e) {
      return {
        configObj: null,
        error: e
      };
    } else e.logger.log(O.INFO, R.SKIPPING_JSON_VALIDATION, X);
    var r = [t];
...
var le = function () {
  function e(e) {
    ...
    try {
      if (this.jsonSchemaValidator = e.jsonSchemaValidator, !e.datafile && !e.sdkKey) {
        var t = new Error(f(N.DATAFILE_AND_SDK_KEY_MISSING, "PROJECT_CONFIG_MANAGER"));
      ...
      e.datafile && (r = this.handleNewDatafile(e.datafile)), e.sdkKey && e.datafileManager ? (this.datafileManager = e.datafileManager, this.datafileManager.start(), this.readyPromise = this.datafileManager.onReady().then(this.onDatafileManagerReadyFulfill.bind(this), this.onDatafileManagerReadyReject.bind(this)), this.datafileManager.on("update", this.onDatafileManagerUpdate.bind(this))) : this.configObj ? this.readyPromise = Promise.resolve({
        ...
        success: !1,
        reason: ue(r, "Invalid datafile")
      });
    } catch (e) {
      se.error(e), this.readyPromise = Promise.resolve({
        success: !1,
        reason: ue(e, "Error in initialize")
      });
    }
  }
  return e.prototype.onDatafileManagerReadyFulfill = function () {
    ...
    return {
      success: !1,
      reason: ue(null, "Datafile manager is not provided")
    };
  }, e.prototype.onDatafileManagerReadyReject = function (e) {
    return {
      success: !1,
      reason: ue(e, "Failed to become ready")
    };
    ...
    var e, t;
    return !this.optimizelyConfigObj && this.configObj && (this.optimizelyConfigObj = (e = this.configObj, t = ne(this.configObj), new H(e, t))), this.optimizelyConfigObj;
...
var Ee = Math.pow(2, 32),
  Ie = function Ie(e) {
    var t = [],
      r = e.experimentIdMap[e.experimentId].groupId;
    if (r) {
      var i = e.groupIdMap[r];
      if (!i) throw new Error(f(N.INVALID_GROUP_ID, "BUCKETER", r));
      if ("random" === i.policy) {
        var n = ce(i, e.bucketingId, e.userId, e.logger);
        if (null === n) return e.logger.log(O.INFO, R.USER_NOT_IN_ANY_EXPERIMENT, "BUCKETER", e.userId, r), t.push([R.USER_NOT_IN_ANY_EXPERIMENT, "BUCKETER", e.userId, r]), {
          result: null,
          reasons: t
        };
        if (n !== e.experimentId) return e.logger.log(O.INFO, R.USER_NOT_BUCKETED_INTO_EXPERIMENT_IN_GROUP, "BUCKETER", e.userId, e.experimentKey, r), t.push([R.USER_NOT_BUCKETED_INTO_EXPERIMENT_IN_GROUP, "BUCKETER", e.userId, e.experimentKey, r]), {
          result: null,
          reasons: t
        };
        e.logger.log(O.INFO, R.USER_BUCKETED_INTO_EXPERIMENT_IN_GROUP, "BUCKETER", e.userId, e.experimentKey, r), t.push([R.USER_BUCKETED_INTO_EXPERIMENT_IN_GROUP, "BUCKETER", e.userId, e.experimentKey, r]);
      }
    }
    var o = "" + e.bucketingId + e.experimentId,
      a = de(o);
    e.logger.log(O.DEBUG, R.USER_ASSIGNED_TO_EXPERIMENT_BUCKET, "BUCKETER", a, e.userId), t.push([R.USER_ASSIGNED_TO_EXPERIMENT_BUCKET, "BUCKETER", a, e.userId]);
    var s = _e(a, e.trafficAllocationConfig);
    return null === s || e.variationIdMap[s] ? {
      result: s,
      reasons: t
    } : (s && (e.logger.log(O.WARNING, R.INVALID_VARIATION_ID, "BUCKETER"), t.push([R.INVALID_VARIATION_ID, "BUCKETER"])), {
      result: null,
      reasons: t
    });
  },
  ce = function ce(e, t, r, i) {
    var n = "" + t + e.id,
      o = de(n);
    i.log(O.DEBUG, R.USER_ASSIGNED_TO_EXPERIMENT_BUCKET, "BUCKETER", o, r);
  ...
  de = function de(e) {
    try {
      ...
      throw new Error(f(N.INVALID_BUCKETING_ID, "BUCKETER", e, t.message));
    }
  },
  fe = t.getLogger();
function ge(e) {
...
function Ne(e) {
  ...
  if (function (e) {
    return /\s/.test(e);
  }(e)) return fe.warn(R.UNKNOWN_MATCH_TYPE, "SEMANTIC VERSION", e), null;
  if (pe(e) ? (t = e.substring(0, e.indexOf("-")), r = e.substring(e.indexOf("-") + 1)) : Oe(e) && (t = e.substring(0, e.indexOf("+")), r = e.substring(e.indexOf("+") + 1)), "string" != typeof t || "string" != typeof r) return null;
  var i = t.split(".").length - 1;
  if (i > 2) return fe.warn(R.UNKNOWN_MATCH_TYPE, "SEMANTIC VERSION", e), null;
  var n = t.split(".");
  if (n.length != i + 1) return fe.warn(R.UNKNOWN_MATCH_TYPE, "SEMANTIC VERSION", e), null;
  for (var o = 0, a = n; o < a.length; o++) {
    if (!ge(a[o])) return fe.warn(R.UNKNOWN_MATCH_TYPE, "SEMANTIC VERSION", e), null;
  }
  return r && n.push(r), n;
}
var Re = "CUSTOM_ATTRIBUTE_CONDITION_EVALUATOR",
  ...
  he = {};
function Ae(e) {
  return "string" == typeof e || "boolean" == typeof e || p.isNumber(e);
}
function ye(e, t) {
  var r = e.value,
    i = typeof r,
    ...
    o = t[n],
    a = typeof o;
  return !Ae(r) || p.isNumber(r) && !p.isSafeInteger(r) ? (ve.warn(R.UNEXPECTED_CONDITION_VALUE, Re, JSON.stringify(e)), null) : null === o ? (ve.debug(R.UNEXPECTED_TYPE_NULL, Re, JSON.stringify(e), n), null) : Ae(o) && i === a ? p.isNumber(o) && !p.isSafeInteger(o) ? (ve.warn(R.OUT_OF_BOUNDS, Re, JSON.stringify(e), n), null) : r === o : (ve.warn(R.UNEXPECTED_TYPE, Re, JSON.stringify(e), a, n), null);
}
function Ue(e, t) {
  var r = e.name,
    i = t[r],
    n = typeof i,
    o = e.value;
  return null !== o && p.isSafeInteger(o) ? null === i ? (ve.debug(R.UNEXPECTED_TYPE_NULL, Re, JSON.stringify(e), r), !1) : p.isNumber(i) ? !!p.isSafeInteger(i) || (ve.warn(R.OUT_OF_BOUNDS, Re, JSON.stringify(e), r), !1) : (ve.warn(R.UNEXPECTED_TYPE, Re, JSON.stringify(e), n, r), !1) : (ve.warn(R.UNEXPECTED_CONDITION_VALUE, Re, JSON.stringify(e)), !1);
}
function De(e, t) {
  var r = e.name,
    i = t[r],
    n = typeof i,
    o = e.value;
  return "string" != typeof o ? (ve.warn(R.UNEXPECTED_CONDITION_VALUE, Re, JSON.stringify(e)), null) : null === i ? (ve.debug(R.UNEXPECTED_TYPE_NULL, Re, JSON.stringify(e), r), null) : "string" != typeof i ? (ve.warn(R.UNEXPECTED_TYPE, Re, JSON.stringify(e), n, r), null) : function (e, t) {
    var r = Ne(t),
      i = Ne(e);
    if (!r || !i) return null;
    for (var n = r.length, o = 0; o < i.length; o++) {
      if (n <= o) return pe(e) || Oe(e) ? 1 : -1;
      if (ge(r[o])) {
        var a = parseInt(r[o]),
          s = parseInt(i[o]);
        if (a > s) return 1;
        ...
        if (r[o] < i[o]) return pe(e) && !pe(t) ? 1 : -1;
        if (r[o] > i[o]) return !pe(e) && pe(t) ? -1 : 1;
      }
    }
...
he.exact = ye, he.exists = function (e, t) {
  var r = t[e.name];
  return null != r;
}, he.gt = function (e, t) {
  var r = t[e.name],
    i = e.value;
  if (!Ue(e, t) || null === i) return null;
  return r > i;
}, he.ge = function (e, t) {
  var r = t[e.name],
    i = e.value;
  ...
  if (!Ue(e, t) || null === i) return null;
  return r <= i;
}, he.substring = function (e, t) {
  var r = e.name,
    i = t[e.name],
    n = typeof i,
    o = e.value;
  if ("string" != typeof o) return ve.warn(R.UNEXPECTED_CONDITION_VALUE, Re, JSON.stringify(e)), null;
  if (null === i) return ve.debug(R.UNEXPECTED_TYPE_NULL, Re, JSON.stringify(e), r), null;
  if ("string" != typeof i) return ve.warn(R.UNEXPECTED_TYPE, Re, JSON.stringify(e), n, r), null;
  return -1 !== i.indexOf(o);
}, he.semver_eq = function (e, t) {
  var r = De(e, t);
  if (null === r) return null;
  return 0 === r;
}, he.semver_gt = function (e, t) {
  var r = De(e, t);
  if (null === r) return null;
  return r > 0;
}, he.semver_ge = function (e, t) {
  var r = De(e, t);
  if (null === r) return null;
  return r >= 0;
}, he.semver_lt = function (e, t) {
  var r = De(e, t);
  if (null === r) return null;
  return r < 0;
}, he.semver_le = function (e, t) {
  var r = De(e, t);
  if (null === r) return null;
  return r <= 0;
};
var Le = Object.freeze({
    ...
    evaluate: function evaluate(e, t) {
      var r = e.match;
      if (void 0 !== r && -1 === Te.indexOf(r)) return ve.warn(R.UNKNOWN_MATCH_TYPE, Re, JSON.stringify(e)), null;
      var i = e.name;
      return t.hasOwnProperty(i) || "exists" == r ? (r && he[r] || ye)(e, t) : (ve.debug(R.MISSING_ATTRIBUTE_VALUE, Re, JSON.stringify(e), i), null);
    }
  }),
  Se = t.getLogger(),
  me = function () {
    function e(e) {
      this.typeToEvaluatorMap = p.assign({}, e, {
        custom_attribute: Le
      });
    }
    return e.prototype.evaluate = function (e, t, r) {
      ...
      return !!Y(e, function (e) {
        var n = t[e];
        if (n) {
          Se.log(O.DEBUG, R.EVALUATING_AUDIENCE, "AUDIENCE_EVALUATOR", e, JSON.stringify(n.conditions));
          var o = Y(n.conditions, i.evaluateConditionWithUserAttributes.bind(i, r)),
            a = null === o ? "UNKNOWN" : o.toString().toUpperCase();
          return Se.log(O.DEBUG, R.AUDIENCE_EVALUATION_RESULT, "AUDIENCE_EVALUATOR", e, a), o;
        }
        return null;
      });
    }, e.prototype.evaluateConditionWithUserAttributes = function (e, t) {
      var r = this.typeToEvaluatorMap[t.type];
      if (!r) return Se.log(O.WARNING, R.UNKNOWN_CONDITION_TYPE, "AUDIENCE_EVALUATOR", JSON.stringify(t)), null;
      try {
...
var Ce = "DECISION_SERVICE",
  Fe = function () {
    function e(e) {
      var t;
      this.audienceEvaluator = (t = e.UNSTABLE_conditionEvaluators, new me(t)), this.forcedVariationMap = {}, this.logger = e.logger, this.userProfileService = e.userProfileService || null;
    }
    return e.prototype.getVariation = function (e, t, r, i) {
      ...
      var n = r.getUserId(),
        ...
        s = [],
        u = t.key;
      if (!this.checkIfExperimentIsActive(e, u)) return this.logger.log(O.INFO, R.EXPERIMENT_NOT_RUNNING, Ce, u), s.push([R.EXPERIMENT_NOT_RUNNING, Ce, u]), {
        result: null,
        reasons: s
      };
      var l = this.getForcedVariation(e, u, n);
      s.push.apply(s, l.reasons);
      var E = l.result;
      if (E) return {
        result: E,
        reasons: s
      };
      var I = this.getWhitelistedVariation(t, n);
      ...
      var _ = i[exports.N1.IGNORE_USER_PROFILE_SERVICE],
        d = this.resolveExperimentBucketMap(n, o);
      if (!_ && (c = this.getStoredVariation(e, t, n, d))) return this.logger.log(O.INFO, R.RETURNING_STORED_VARIATION, Ce, c.key, u, n), s.push([R.RETURNING_STORED_VARIATION, Ce, c.key, u, n]), {
        result: c.key,
        reasons: s
      };
      var f = this.checkIfUserIsInAudience(e, t, A.EXPERIMENT, o, "");
      if (s.push.apply(s, f.reasons), !f.result) return this.logger.log(O.INFO, R.USER_NOT_IN_EXPERIMENT, Ce, n, u), s.push([R.USER_NOT_IN_EXPERIMENT, Ce, n, u]), {
        result: null,
        reasons: s
      };
      var g = this.buildBucketerParams(e, t, a, n),
        p = Ie(g);
      s.push.apply(s, p.reasons);
      var N = p.result;
      return N && (c = e.variationIdMap[N]), c ? (this.logger.log(O.INFO, R.USER_HAS_VARIATION, Ce, n, c.key, u), s.push([R.USER_HAS_VARIATION, Ce, n, c.key, u]), _ || this.saveUserProfile(t, c, n, d), {
        result: c.key,
        reasons: s
      }) : (this.logger.log(O.DEBUG, R.USER_HAS_NO_VARIATION, Ce, n, u), s.push([R.USER_HAS_NO_VARIATION, Ce, n, u]), {
        result: null,
        reasons: s
      });
      ...
      var r = this.getUserProfile(e) || {},
        i = t[v.STICKY_BUCKETING_KEY];
      return p.assign({}, r.experiment_bucket_map, i);
      ...
      if (e.forcedVariations && e.forcedVariations.hasOwnProperty(t)) {
        ...
        return e.variationKeyMap.hasOwnProperty(i) ? (this.logger.log(O.INFO, R.USER_FORCED_IN_VARIATION, Ce, t, i), r.push([R.USER_FORCED_IN_VARIATION, Ce, t, i]), {
          result: e.variationKeyMap[i],
          reasons: r
        }) : (this.logger.log(O.ERROR, R.FORCED_BUCKETING_FAILED, Ce, i, t), r.push([R.FORCED_BUCKETING_FAILED, Ce, i, t]), {
          result: null,
          reasons: r
        });
      }
      ...
      var o = [],
        ...
        s = e.audiencesById;
      this.logger.log(O.DEBUG, R.EVALUATING_AUDIENCES_COMBINED, Ce, r, n || t.key, JSON.stringify(a)), o.push([R.EVALUATING_AUDIENCES_COMBINED, Ce, r, n || t.key, JSON.stringify(a)]);
      var u = this.audienceEvaluator.evaluate(a, s, i);
      return this.logger.log(O.INFO, R.AUDIENCE_EVALUATION_RESULT_COMBINED, Ce, r, n || t.key, u.toString().toUpperCase()), o.push([R.AUDIENCE_EVALUATION_RESULT_COMBINED, Ce, r, n || t.key, u.toString().toUpperCase()]), {
        result: u,
        reasons: o
      };
      ...
      if (i.hasOwnProperty(t.id)) {
        ...
        this.logger.log(O.INFO, R.SAVED_VARIATION_NOT_FOUND, Ce, r, o, t.key);
      }
      return null;
      ...
      try {
        ...
        this.logger.log(O.ERROR, N.USER_PROFILE_LOOKUP_ERROR, Ce, e, t.message);
      }
      return null;
      ...
      if (this.userProfileService) try {
        ...
        }), this.logger.log(O.INFO, R.SAVED_VARIATION, Ce, t.key, e.key, r);
      } catch (e) {
        this.logger.log(O.ERROR, N.USER_PROFILE_SAVE_ERROR, Ce, r, e.message);
      }
      ...
      var u = s.result,
        l = r.getUserId();
      return u.variation ? (this.logger.log(O.DEBUG, R.USER_IN_ROLLOUT, Ce, l, t.key), n.push([R.USER_IN_ROLLOUT, Ce, l, t.key]), {
        result: u,
        reasons: n
      }) : (this.logger.log(O.DEBUG, R.USER_NOT_IN_ROLLOUT, Ce, l, t.key), n.push([R.USER_NOT_IN_ROLLOUT, Ce, l, t.key]), {
        result: u,
        reasons: n
      });
      ...
      if (t.experimentIds.length > 0) for (o = 0; o < t.experimentIds.length; o++) {
        ...
        if (u && (n = this.getVariationFromExperimentRule(e, t.key, u, r, i), a.push.apply(a, n.reasons), s = n.result)) {
          var l = null;
          return (l = u.variationKeyMap[s]) || (l = re(e, t.key, s)), {
            result: {
              experiment: u,
              variation: l,
              decisionSource: h.FEATURE_TEST
            },
            reasons: a
          };
        }
      } else this.logger.log(O.DEBUG, R.FEATURE_HAS_NO_EXPERIMENTS, Ce, t.key), a.push([R.FEATURE_HAS_NO_EXPERIMENTS, Ce, t.key]);
      return {
        result: {
          experiment: null,
          variation: null,
      ...
      var i = [];
      if (!t.rolloutId) return this.logger.log(O.DEBUG, R.NO_ROLLOUT_EXISTS, Ce, t.key), i.push([R.NO_ROLLOUT_EXISTS, Ce, t.key]), {
        result: {
          experiment: null,
          variation: null,
          decisionSource: h.ROLLOUT
        },
        reasons: i
      };
      var n = e.rolloutIdMap[t.rolloutId];
      if (!n) return this.logger.log(O.ERROR, N.INVALID_ROLLOUT_ID, Ce, t.rolloutId, t.key), i.push([N.INVALID_ROLLOUT_ID, Ce, t.rolloutId, t.key]), {
        result: {
          experiment: null,
          variation: null,
          decisionSource: h.ROLLOUT
      ...
      var o,
        ...
        s,
        u = n.experiments;
      if (0 === u.length) return this.logger.log(O.ERROR, R.ROLLOUT_HAS_NO_EXPERIMENTS, Ce, t.rolloutId), i.push([R.ROLLOUT_HAS_NO_EXPERIMENTS, Ce, t.rolloutId]), {
        result: {
          experiment: null,
          variation: null,
          decisionSource: h.ROLLOUT
      ...
      for (var l = 0; l < u.length;) {
        if (o = this.getVariationFromDeliveryRule(e, t.key, u, l, r), i.push.apply(i, o.reasons), s = o.result, a = o.skipToEveryoneElse, s) return {
          result: {
      ...
      var r = e;
      return null != t && "object" == typeof t && t.hasOwnProperty(v.BUCKETING_ID) && ("string" == typeof t[v.BUCKETING_ID] ? (r = t[v.BUCKETING_ID], this.logger.log(O.DEBUG, R.VALID_BUCKETING_ID, Ce, r)) : this.logger.log(O.WARNING, R.BUCKETING_ID_NOT_STRING, Ce)), r;
      ...
      var n,
        ...
        s = null,
        u = t.getUserId();
      return e && a && (n = a.variationKey, (s = re(e, r, n)) ? i ? (this.logger.log(O.INFO, R.USER_HAS_FORCED_DECISION_WITH_RULE_SPECIFIED, n, r, i, u), o.push([R.USER_HAS_FORCED_DECISION_WITH_RULE_SPECIFIED, n, r, i, u])) : (this.logger.log(O.INFO, R.USER_HAS_FORCED_DECISION_WITH_NO_RULE_SPECIFIED, n, r, u), o.push([R.USER_HAS_FORCED_DECISION_WITH_NO_RULE_SPECIFIED, n, r, u])) : i ? (this.logger.log(O.INFO, R.USER_HAS_FORCED_DECISION_WITH_RULE_SPECIFIED_BUT_INVALID, r, i, u), o.push([R.USER_HAS_FORCED_DECISION_WITH_RULE_SPECIFIED_BUT_INVALID, r, i, u])) : (this.logger.log(O.INFO, R.USER_HAS_FORCED_DECISION_WITH_NO_RULE_SPECIFIED_BUT_INVALID, r, u), o.push([R.USER_HAS_FORCED_DECISION_WITH_NO_RULE_SPECIFIED_BUT_INVALID, r, u]))), {
        result: s,
        reasons: o
      };
    }, e.prototype.removeForcedVariation = function (e, t, r) {
      if (!e) throw new Error(f(N.INVALID_USER_ID, Ce));
      if (!this.forcedVariationMap.hasOwnProperty(e)) throw new Error(f(N.USER_NOT_IN_FORCED_VARIATION, Ce, e));
      delete this.forcedVariationMap[e][t], this.logger.log(O.DEBUG, R.VARIATION_REMOVED_FOR_USER, Ce, r, e);
    }, e.prototype.setInForcedVariationMap = function (e, t, r) {
      this.forcedVariationMap.hasOwnProperty(e) || (this.forcedVariationMap[e] = {}), this.forcedVariationMap[e][t] = r, this.logger.log(O.DEBUG, R.USER_MAPPED_TO_FORCED_VARIATION, Ce, r, t, e);
    }, e.prototype.getForcedVariation = function (e, t, r) {
      var i,
        n = [],
        o = this.forcedVariationMap[r];
      if (!o) return this.logger.log(O.DEBUG, R.USER_HAS_NO_FORCED_VARIATION, Ce, r), {
        result: null,
        reasons: n
      };
      try {
        var a = Q(e, t);
        if (!a.hasOwnProperty("id")) return this.logger.log(O.ERROR, N.IMPROPERLY_FORMATTED_EXPERIMENT, Ce, t), n.push([N.IMPROPERLY_FORMATTED_EXPERIMENT, Ce, t]), {
          result: null,
          reasons: n
        };
        i = a.id;
      } catch (e) {
        return this.logger.log(O.ERROR, e.message), n.push(e.message), {
          result: null,
          reasons: n
        };
      }
      var s = o[i];
      if (!s) return this.logger.log(O.DEBUG, R.USER_HAS_NO_FORCED_VARIATION_FOR_EXPERIMENT, Ce, t, r), {
        result: null,
        reasons: n
      };
      var u = $(e, s);
      return u ? (this.logger.log(O.DEBUG, R.USER_HAS_FORCED_VARIATION, Ce, u, t, r), n.push([R.USER_HAS_FORCED_VARIATION, Ce, u, t, r])) : this.logger.log(O.DEBUG, R.USER_HAS_NO_FORCED_VARIATION_FOR_EXPERIMENT, Ce, t, r), {
        result: u,
        reasons: n
      };
    }, e.prototype.setForcedVariation = function (e, t, r, i) {
      if (null != i && !Ve(i)) return this.logger.log(O.ERROR, N.INVALID_VARIATION_KEY, Ce), !1;
      var n;
      try {
        var o = Q(e, t);
        if (!o.hasOwnProperty("id")) return this.logger.log(O.ERROR, N.IMPROPERLY_FORMATTED_EXPERIMENT, Ce, t), !1;
        n = o.id;
      } catch (e) {
      ...
      if (!a) return this.logger.log(O.ERROR, N.NO_VARIATION_FOR_EXPERIMENT_KEY, Ce, i, t), !1;
      try {
      ...
      var E,
        ...
        f = n.getUserId(),
        g = n.getAttributes(),
        p = this.getBucketingId(f, g),
        N = i === r.length - 1,
        v = N ? "Everyone Else" : i + 1,
        T = null,
        h = this.checkIfUserIsInAudience(e, s, A.RULE, g, v);
      return o.push.apply(o, h.reasons), h.result ? (this.logger.log(O.DEBUG, R.USER_MEETS_CONDITIONS_FOR_TARGETING_RULE, Ce, f, v), o.push([R.USER_MEETS_CONDITIONS_FOR_TARGETING_RULE, Ce, f, v]), I = this.buildBucketerParams(e, s, p, f), c = Ie(I), o.push.apply(o, c.reasons), (E = c.result) && (d = E, T = (_ = e).variationIdMap.hasOwnProperty(d) ? _.variationIdMap[d] : null), T ? (this.logger.log(O.DEBUG, R.USER_BUCKETED_INTO_TARGETING_RULE, Ce, f, v), o.push([R.USER_BUCKETED_INTO_TARGETING_RULE, Ce, f, v])) : N || (this.logger.log(O.DEBUG, R.USER_NOT_BUCKETED_INTO_TARGETING_RULE, Ce, f, v), o.push([R.USER_NOT_BUCKETED_INTO_TARGETING_RULE, Ce, f, v]), a = !0)) : (this.logger.log(O.DEBUG, R.USER_DOESNT_MEET_CONDITIONS_FOR_TARGETING_RULE, Ce, f, v), o.push([R.USER_DOESNT_MEET_CONDITIONS_FOR_TARGETING_RULE, Ce, f, v])), {
        result: T,
        reasons: o,
        skipToEveryoneElse: a
      };
...
function Me(e, t) {
  if (e.hasOwnProperty("revenue")) {
    var r = e.revenue,
      i = void 0;
    return "string" == typeof r ? (i = parseInt(r), isNaN(i) ? (t.log(O.INFO, R.FAILED_TO_PARSE_REVENUE, "EVENT_TAG_UTILS", r), null) : (t.log(O.INFO, R.PARSED_REVENUE_VALUE, "EVENT_TAG_UTILS", i), i)) : "number" == typeof r ? (i = r, t.log(O.INFO, R.PARSED_REVENUE_VALUE, "EVENT_TAG_UTILS", i), i) : null;
  }
  return null;
}
function Pe(e, t) {
  if (e.hasOwnProperty("value")) {
    var r = e.value,
      i = void 0;
    return "string" == typeof r ? (i = parseFloat(r), isNaN(i) ? (t.log(O.INFO, R.FAILED_TO_PARSE_VALUE, "EVENT_TAG_UTILS", r), null) : (t.log(O.INFO, R.PARSED_NUMERIC_VALUE, "EVENT_TAG_UTILS", i), i)) : "number" == typeof r ? (i = r, t.log(O.INFO, R.PARSED_NUMERIC_VALUE, "EVENT_TAG_UTILS", i), i) : null;
  }
  return null;
}
function be(e, t) {
  return "string" == typeof e && ("string" == typeof t || "boolean" == typeof t || p.isNumber(t) && p.isSafeInteger(t));
}
...
function ke(e) {
  var t,
    ...
    l,
    E = xe(e),
    I = (t = e.configObj, r = e.experimentId, i = e.variationId, n = e.ruleKey, o = e.ruleType, a = e.flagKey, s = e.enabled, u = r ? J(t, r) : null, l = i ? $(t, i) : null, {
      decisions: [{
        campaign_id: u,
        experiment_id: r,
        variation_id: i,
...
var Xe = t.getLogger("EVENT_BUILDER");
function ze(e, t) {
  var r = [];
...
var Je = "USER_PROFILE_SERVICE_VALIDATOR";
var Ze = function () {
    function e(e) {
      var t,
        r = this,
        i = e.clientEngine;
      i || (e.logger.log(O.INFO, R.INVALID_CLIENT_ENGINE, "OPTIMIZELY", i), i = "node-sdk"), this.clientEngine = i, this.clientVersion = e.clientVersion || "4.9.2", this.errorHandler = e.errorHandler, this.isOptimizelyConfigValid = e.isValidInstance, this.logger = e.logger;
      var n = null !== (t = e.defaultDecideOptions) && void 0 !== t ? t : [];
      Array.isArray(n) || (this.logger.log(O.DEBUG, R.INVALID_DEFAULT_DECIDE_OPTIONS, "OPTIMIZELY"), n = []);
      var o = {};
      n.forEach(function (e) {
        exports.N1[e] ? o[e] = !0 : r.logger.log(O.WARNING, R.UNRECOGNIZED_DECIDE_OPTION, "OPTIMIZELY", e);
      }), this.defaultDecideOptions = o, this.projectConfigManager = function (e) {
        return new le(e);
      }({
        datafile: e.datafile,
        ...
        r.logger.log(O.INFO, R.UPDATED_OPTIMIZELY_CONFIG, "OPTIMIZELY", e.revision, e.projectId), r.notificationCenter.sendNotifications(g.OPTIMIZELY_CONFIG_UPDATE);
      });
      var a,
        s = this.projectConfigManager.onReady(),
        u = null;
      if (e.userProfileService) try {
        (function (e) {
          if ("object" == typeof e && null !== e) {
            if ("function" != typeof e.lookup) throw new Error(f(N.INVALID_USER_PROFILE_SERVICE, Je, "Missing function 'lookup'"));
            if ("function" != typeof e.save) throw new Error(f(N.INVALID_USER_PROFILE_SERVICE, Je, "Missing function 'save'"));
            return !0;
          }
          throw new Error(f(N.INVALID_USER_PROFILE_SERVICE, Je));
        })(e.userProfileService) && (u = e.userProfileService, this.logger.log(O.INFO, R.VALID_USER_PROFILE_SERVICE, "OPTIMIZELY"));
      } catch (e) {
        this.logger.log(O.WARNING, e.message);
      }
      this.decisionService = (a = {
        userProfileService: u,
        logger: this.logger,
        UNSTABLE_conditionEvaluators: e.UNSTABLE_conditionEvaluators
      }, new Fe(a)), this.notificationCenter = e.notificationCenter, this.eventProcessor = e.eventProcessor;
      var l = this.eventProcessor.start();
      this.readyPromise = Promise.all([s, l]).then(function (e) {
        return e[0];
    ...
    return e.prototype.isValidInstance = function () {
      ...
      try {
        if (!this.isValidInstance()) return this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "activate"), null;
        ...
        try {
          ...
          if (!function (e, t) {
            return "Running" === q(e, t);
          }(i, e)) return this.logger.log(O.DEBUG, R.SHOULD_NOT_DISPATCH_ACTIVATE, "OPTIMIZELY", e), n;
          var o = Q(i, e),
            a = {
              experiment: o,
              variation: o.variationKeyMap[n],
              decisionSource: h.EXPERIMENT
            };
          return this.sendImpressionEvent(a, "", t, !0, r), n;
        } catch (r) {
          return this.logger.log(O.ERROR, r.message), this.logger.log(O.INFO, R.NOT_ACTIVATING_USER, "OPTIMIZELY", t, e), this.errorHandler.handleError(r), null;
        }
      } catch (e) {
      ...
      if (o) {
        ...
        a && a.variationKeyMap && "" !== E && (c = a.variationKeyMap[E]), this.notificationCenter.sendNotifications(g.ACTIVATE, {
          experiment: a,
          userId: r,
          attributes: n,
          variation: c,
      ...
      try {
        if (!this.isValidInstance()) return void this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "track");
        if (!this.validateInputs({
          user_id: t,
          event_key: e
        }, r, i)) return;
        ...
        }(n, e)) return this.logger.log(O.WARNING, R.EVENT_KEY_NOT_FOUND, "OPTIMIZELY", e), void this.logger.log(O.WARNING, R.NOT_TRACKING_USER, "OPTIMIZELY", t);
        var o = function (e) {
          var t = e.configObj,
            r = e.userId,
            i = e.userAttributes,
        ...
        this.logger.log(O.INFO, R.TRACK_EVENT, "OPTIMIZELY", e, t), this.eventProcessor.process(o), this.emitNotificationCenterTrack(e, t, r, i);
      } catch (e) {
        this.logger.log(O.ERROR, e.message), this.errorHandler.handleError(e), this.logger.log(O.ERROR, R.NOT_TRACKING_USER, "OPTIMIZELY", t);
      }
      ...
      try {
        if (!this.isValidInstance()) return this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "getVariation"), null;
        try {
          if (!this.validateInputs({
            experiment_key: e,
            user_id: t
          ...
          if (!n) return this.logger.log(O.DEBUG, N.INVALID_EXPERIMENT_KEY, "OPTIMIZELY", e), null;
          var o = this.decisionService.getVariation(i, n, this.createUserContext(t, r)).result,
            a = (s = i, u = n.id, s.experimentFeatureMap.hasOwnProperty(u) ? T.FEATURE_TEST : T.AB_TEST);
      ...
      try {
        if (e.hasOwnProperty("user_id")) {
          var i = e.user_id;
          if ("string" != typeof i || null === i || "undefined" === i) throw new Error(f(N.INVALID_INPUT_FORMAT, "OPTIMIZELY", "user_id"));
          delete e.user_id;
        }
        return Object.keys(e).forEach(function (t) {
          if (!Ve(e[t])) throw new Error(f(N.INVALID_INPUT_FORMAT, "OPTIMIZELY", t));
        }), t && function (e) {
          if ("object" != typeof e || Array.isArray(e) || null === e) throw new Error(f(N.INVALID_ATTRIBUTES, "ATTRIBUTES_VALIDATOR"));
          Object.keys(e).forEach(function (t) {
            if (void 0 === e[t]) throw new Error(f(N.UNDEFINED_ATTRIBUTE, "ATTRIBUTES_VALIDATOR", t));
          });
        }(t), r && function (e) {
          if ("object" != typeof e || Array.isArray(e) || null === e) throw new Error(f(N.INVALID_EVENT_TAGS, "EVENT_TAGS_VALIDATOR"));
        }(r), !0;
      } catch (e) {
        return this.logger.log(O.ERROR, e.message), this.errorHandler.handleError(e), !1;
      }
    }, e.prototype.notActivatingExperiment = function (e, t) {
      return this.logger.log(O.INFO, R.NOT_ACTIVATING_USER, "OPTIMIZELY", t, e), null;
      ...
      try {
        if (!this.isValidInstance()) return this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "isFeatureEnabled"), !1;
        if (!this.validateInputs({
          feature_key: e,
          user_id: t
        }, r)) return !1;
        ...
        u === h.FEATURE_TEST && (o = {
          experimentKey: l,
          variationKey: E
        }), (u === h.FEATURE_TEST || u === h.ROLLOUT && ae(i)) && this.sendImpressionEvent(s, n.key, t, I, r), !0 === I ? this.logger.log(O.INFO, R.FEATURE_ENABLED_FOR_USER, "OPTIMIZELY", e, t) : (this.logger.log(O.INFO, R.FEATURE_NOT_ENABLED_FOR_USER, "OPTIMIZELY", e, t), I = !1);
        var c = {
          featureKey: e,
          featureEnabled: I,
      ...
      try {
        var i = [];
        if (!this.isValidInstance()) return this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "getEnabledFeatures"), i;
        if (!this.validateInputs({
          user_id: e
        })) return i;
        var n = this.projectConfigManager.getConfig();
        return n ? (I(n.featureKeyMap).forEach(function (n) {
      ...
      try {
        return this.isValidInstance() ? this.getFeatureVariableForType(e, t, null, r, i) : (this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "getFeatureVariable"), null);
      } catch (e) {
        return this.logger.log(O.ERROR, e.message), this.errorHandler.handleError(e), null;
      }
      ...
      var s = function (e, t, r, i) {
        ...
        if (!n) return i.log(O.ERROR, N.FEATURE_NOT_IN_DATAFILE, X, t), null;
        var o = n.variableKeyMap[r];
        return o || (i.log(O.ERROR, N.VARIABLE_KEY_NOT_IN_DATAFILE, X, r, t), null);
      }(o, e, t, this.logger);
      if (!s) return null;
      if (r && s.type !== r) return this.logger.log(O.WARNING, R.VARIABLE_REQUESTED_WITH_WRONG_TYPE, "OPTIMIZELY", r, s.type), null;
      var u = this.createUserContext(i, n),
        l = this.decisionService.getVariationForFeature(o, a, u).result,
        E = je(l),
        I = this.getFeatureVariableValueFromVariation(e, E, l.variation, s, i),
        c = {};
      return l.decisionSource === h.FEATURE_TEST && null !== l.experiment && null !== l.variation && (c = {
      ...
      if (null !== r) {
        var s = function (e, t, r, i) {
          if (!t || !r) return null;
          if (!e.variationVariableUsageMap.hasOwnProperty(r.id)) return i.log(O.ERROR, N.VARIATION_ID_NOT_IN_DATAFILE_NO_EXPERIMENT, X, r.id), null;
          var n = e.variationVariableUsageMap[r.id][t.id];
          return n ? n.value : null;
        }(o, i, r, this.logger);
        null !== s ? t ? (a = s, this.logger.log(O.INFO, R.USER_RECEIVED_VARIABLE_VALUE, "OPTIMIZELY", a, i.key, e)) : this.logger.log(O.INFO, R.FEATURE_NOT_ENABLED_RETURN_DEFAULT_VARIABLE_VALUE, "OPTIMIZELY", e, n, a) : this.logger.log(O.INFO, R.VARIABLE_NOT_USED_RETURN_DEFAULT_VARIABLE_VALUE, "OPTIMIZELY", i.key, r.key);
      } else this.logger.log(O.INFO, R.USER_RECEIVED_DEFAULT_VARIABLE_VALUE, "OPTIMIZELY", n, i.key, e);
      return function (e, t, r) {
        var i;
        switch (t) {
          case y.BOOLEAN:
            "true" !== e && "false" !== e ? (r.log(O.ERROR, N.UNABLE_TO_CAST_VALUE, X, e, t), i = null) : i = "true" === e;
            break;
          case y.INTEGER:
            i = parseInt(e, 10), isNaN(i) && (r.log(O.ERROR, N.UNABLE_TO_CAST_VALUE, X, e, t), i = null);
            break;
          case y.DOUBLE:
            i = parseFloat(e), isNaN(i) && (r.log(O.ERROR, N.UNABLE_TO_CAST_VALUE, X, e, t), i = null);
            break;
          case y.JSON:
            try {
              i = JSON.parse(e);
            } catch (n) {
              r.log(O.ERROR, N.UNABLE_TO_CAST_VALUE, X, e, t), i = null;
            }
            break;
          default:
            i = e;
      ...
      try {
        return this.isValidInstance() ? this.getFeatureVariableForType(e, t, y.BOOLEAN, r, i) : (this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "getFeatureVariableBoolean"), null);
      } catch (e) {
        return this.logger.log(O.ERROR, e.message), this.errorHandler.handleError(e), null;
      }
    }, e.prototype.getFeatureVariableDouble = function (e, t, r, i) {
      try {
        return this.isValidInstance() ? this.getFeatureVariableForType(e, t, y.DOUBLE, r, i) : (this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "getFeatureVariableDouble"), null);
      } catch (e) {
        return this.logger.log(O.ERROR, e.message), this.errorHandler.handleError(e), null;
      }
    }, e.prototype.getFeatureVariableInteger = function (e, t, r, i) {
      try {
        return this.isValidInstance() ? this.getFeatureVariableForType(e, t, y.INTEGER, r, i) : (this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "getFeatureVariableInteger"), null);
      } catch (e) {
        return this.logger.log(O.ERROR, e.message), this.errorHandler.handleError(e), null;
      }
    }, e.prototype.getFeatureVariableString = function (e, t, r, i) {
      try {
        return this.isValidInstance() ? this.getFeatureVariableForType(e, t, y.STRING, r, i) : (this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "getFeatureVariableString"), null);
      } catch (e) {
        return this.logger.log(O.ERROR, e.message), this.errorHandler.handleError(e), null;
      }
    }, e.prototype.getFeatureVariableJSON = function (e, t, r, i) {
      try {
        return this.isValidInstance() ? this.getFeatureVariableForType(e, t, y.JSON, r, i) : (this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "getFeatureVariableJSON"), null);
      } catch (e) {
        return this.logger.log(O.ERROR, e.message), this.errorHandler.handleError(e), null;
      }
      ...
      var i = this;
      try {
        if (!this.isValidInstance()) return this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "getAllFeatureVariables"), null;
        if (!this.validateInputs({
          feature_key: e,
          user_id: t
        }, r)) return null;
        ...
        o.variables.forEach(function (r) {
          l[r.key] = i.getFeatureVariableValueFromVariation(e, u, s.variation, r, t);
        });
        var E = {};
        return s.decisionSource === h.FEATURE_TEST && null !== s.experiment && null !== s.variation && (E = {
      ...
      try {
        ...
        return this.logger.log(O.ERROR, e.message), this.errorHandler.handleError(e), Promise.resolve({
          success: !1,
          reason: String(e)
        });
      }
      ...
      var t,
        r,
        i = this;
      "object" == typeof e && null !== e && void 0 !== e.timeout && (t = e.timeout), p.isSafeInteger(t) || (t = 3e4);
      ...
      var a = setTimeout(function () {
        delete i.readyTimeouts[o], r({
          success: !1,
          reason: f("onReady timeout expired after %s ms", t)
        });
      }, t);
      return this.readyTimeouts[o] = {
        ...
        clearTimeout(a), delete i.readyTimeouts[o], r({
          success: !0
        });
      ...
      var l,
        E = e.getUserId(),
        I = e.getAttributes(),
        c = this.projectConfigManager.getConfig(),
        _ = [];
      if (!this.isValidInstance() || !c) return this.logger.log(O.INFO, R.INVALID_OBJECT, "OPTIMIZELY", "decide"), G(t, e, [D.SDK_NOT_READY]);
      var d = c.featureKeyMap[t];
      if (!d) return this.logger.log(O.ERROR, N.FEATURE_NOT_IN_DATAFILE, "OPTIMIZELY", t), G(t, e, [f(D.FLAG_KEY_INVALID, t)]);
      var p = this.getAllDecideOptions(r),
        v = this.decisionService.findValidatedForcedDecision(c, e, t);
      ...
      if (A) l = {
        ...
        var y = this.decisionService.getVariationForFeature(c, d, e, p);
        _.push.apply(_, y.reasons), l = y.result;
      }
      var U = l.decisionSource,
        L = null !== (n = null === (i = l.experiment) || void 0 === i ? void 0 : i.key) && void 0 !== n ? n : null,
        S = null !== (a = null === (o = l.variation) || void 0 === o ? void 0 : o.key) && void 0 !== a ? a : null,
        m = je(l);
      !0 === m ? this.logger.log(O.INFO, R.FEATURE_ENABLED_FOR_USER, "OPTIMIZELY", t, E) : this.logger.log(O.INFO, R.FEATURE_NOT_ENABLED_FOR_USER, "OPTIMIZELY", t, E);
      var V = {},
        C = !1;
      p[exports.N1.EXCLUDE_VARIABLES] || d.variables.forEach(function (e) {
        V[e.key] = u.getFeatureVariableValueFromVariation(t, m, l.variation, e, E);
      }), !p[exports.N1.DISABLE_DECISION_EVENT] && (U === h.FEATURE_TEST || U === h.ROLLOUT && ae(c)) && (this.sendImpressionEvent(l, t, E, m, I), C = !0);
      var F = [];
      p[exports.N1.INCLUDE_REASONS] && (F = _.map(function (e) {
        return f.apply(void 0, s([e[0]], e.slice(1)));
      }));
      var M = {
        flagKey: t,
        enabled: m,
      ...
      return Array.isArray(e) ? e.forEach(function (e) {
        exports.N1[e] ? r[e] = !0 : t.logger.log(O.WARNING, R.UNRECOGNIZED_DECIDE_OPTION, "OPTIMIZELY", e);
      }) : this.logger.log(O.DEBUG, R.INVALID_DECIDE_OPTIONS, "OPTIMIZELY"), r;
    }, e.prototype.decideForKeys = function (e, t, r) {
      var i = this;
      void 0 === r && (r = []);
      var n = {};
      if (!this.isValidInstance()) return this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "decideForKeys"), n;
      if (0 === t.length) return n;
      var o = this.getAllDecideOptions(r);
      return t.forEach(function (t) {
        var a = i.decide(e, t, r);
        o[exports.N1.ENABLED_FLAGS_ONLY] && !a.enabled || (n[t] = a);
      }), n;
    }, e.prototype.decideAll = function (e, t) {
      void 0 === t && (t = []);
      var r = this.projectConfigManager.getConfig();
      if (!this.isValidInstance() || !r) return this.logger.log(O.ERROR, R.INVALID_OBJECT, "OPTIMIZELY", "decideAll"), {};
      var i = Object.keys(r.featureKeyMap);
      return this.decideForKeys(e, i, t);
    }, e;
  }(),
  We = function We(e) {
    return !("number" != typeof e || !p.isSafeInteger(e)) && e >= 1;
  },
  qe = function qe(e) {
    return !("number" != typeof e || !p.isSafeInteger(e)) && e > 0;
  },
  $e = function () {
    function e(e) {
      var t = this;
      this.logger = e.logger, this.errorHandler = e.errorHandler, this.notificationListeners = {}, I(g).forEach(function (e) {
        t.notificationListeners[e] = [];
      }), this.listenerId = 1;
    }
    return e.prototype.addNotificationListener = function (e, t) {
      try {
        if (!(I(g).indexOf(e) > -1)) return -1;
      ...
      try {
        (this.notificationListeners[e] || []).forEach(function (i) {
          ...
          try {
            ...
            r.logger.log(O.ERROR, R.NOTIFICATION_LISTENER_EXCEPTION, "NOTIFICATION_CENTER", e, t.message);
          }
        });
      } catch (e) {
        this.logger.log(O.ERROR, e.message), this.errorHandler.handleError(e);
...
function et(e, t, r, i) {
  ...
  if ((void 0 === i || "object" == typeof i && null !== i) && p.assign(n, i), r) {
    var a = oe({
        datafile: r,
      ...
      s = a.configObj,
      u = a.error;
    u && t.error(u), s && (n.datafile = ne(s));
  }
  return new o.HttpPollingDatafileManager(n);
}
var tt = t.getLogger();
t.setLogHandler(K()), t.setLogLevel(t.LogLevel.INFO);
var rt = !1,
  it = function it(e) {
    try {
      var i = !1;
      ...
      var n = void 0;
      null == e.eventDispatcher ? (n = new r.LocalStoragePendingEventsDispatcher({
        eventDispatcher: P
      }), rt || (n.sendPendingEvents(), rt = !0)) : n = e.eventDispatcher;
      var o = e.eventBatchSize,
        s = e.eventFlushInterval;
      We(e.eventBatchSize) || (tt.warn("Invalid eventBatchSize %s, defaulting to %s", e.eventBatchSize, 10), o = 10), qe(e.eventFlushInterval) || (tt.warn("Invalid eventFlushInterval %s, defaulting to %s", e.eventFlushInterval, 1e3), s = 1e3);
      var u = t.getErrorHandler(),
        l = new $e({
          logger: tt,
          errorHandler: u
        }),
        ...
        I = _a(_a({
          ...
          eventProcessor: Qe.createEventProcessor(E),
          logger: tt,
          errorHandler: u,
          datafileManager: e.sdkKey ? et(e.sdkKey, tt, e.datafile, e.datafileOptions) : void 0,
          notificationCenter: l,
          isValidInstance: i
        }),
        c = new Ze(I);
      try {
        ...
        tt.error(R.UNABLE_TO_ATTACH_UNLOAD, "INDEX_BROWSER", e.message);
      }
      return c;
    } catch (e) {
      return tt.error(e), null;
    }
  },
  nt = function nt() {
    rt = !1;
  ...
  ot = {
    ...
    createInstance: it,
    __internalResetRetryState: nt,
    OptimizelyDecideOption: exports.N1
  };
__webpack_unused_export__ = ({
  enumerable: !0,
  get: function get() {
...
}), __webpack_unused_export__ = nt, __webpack_unused_export__ = it, exports.ZP = ot, __webpack_unused_export__ = L, __webpack_unused_export__ = F, __webpack_unused_export__ = P, __webpack_unused_export__ = B;
...
var rng = __webpack_require__(671);
var bytesToUuid = __webpack_require__(951);
...
/******/ 			return "static/js/" + chunkId + "." + "3a0df6ab" + ".chunk.js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "create-react-yarn:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcreate_react_yarn"] = self["webpackChunkcreate_react_yarn"] || [];
...
// EXTERNAL MODULE: ./node_modules/@optimizely/optimizely-sdk/dist/optimizely.browser.min.js
var optimizely_browser_min = __webpack_require__(659);
...
var loadOptimizely=/*#__PURE__*/function(){var _ref=_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(setDone){var optimizelyInstance,_yield$optimizelyInst,success,reason,userId,user,decision;return _regeneratorRuntime().wrap(function _callee$(_context){while(1)switch(_context.prev=_context.next){case 0:_context.prev=0;console.log('uuid: '+esm_browser_v4());optimizelyInstance=optimizely_browser_min/* default.createInstance */.ZP.createInstance({logLevel:'error',sdkKey:'your-sdk-key'});if(optimizelyInstance){_context.next=5;break;}throw new Error('Unable to create new Optimizely instance.');case 5:_context.next=7;return optimizelyInstance.onReady();case 7:_yield$optimizelyInst=_context.sent;success=_yield$optimizelyInst.success;reason=_yield$optimizelyInst.reason;userId='test-user-1';user=optimizelyInstance.createUserContext(userId);if(user){_context.next=14;break;}throw new Error("Error: Unable to create new Optimizely User Context for default user (".concat(userId,")."));case 14:decision=user.decideAll();console.log(decision);setDone(true);_context.next=23;break;case 19:_context.prev=19;_context.t0=_context["catch"](0);console.error('Unable to load Optimizely.');console.error(_context.t0);case 23:case"end":return _context.stop();}},_callee,null,[[0,19]]);}));return function loadOptimizely(_x){return _ref.apply(this,arguments);};}();function App_App(){var _useState=(0,react.useState)(false),_useState2=_slicedToArray(_useState,2),done=_useState2[0],setDone=_useState2[1];(0,react.useEffect)(function(){loadOptimizely(setDone);},[]);return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"App",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("header",{className:"App-header",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("img",{src:logo,className:"App-logo",alt:"logo"}),/*#__PURE__*/(0,jsx_runtime.jsx)("p",{children:done?'test done, please check console':'testing sdk'}),/*#__PURE__*/(0,jsx_runtime.jsx)("a",{className:"App-link",href:"https://reactjs.org",target:"_blank",rel:"noopener noreferrer",children:"Learn React"})]})});}/* harmony default export */ var src_App = (App_App);
...
var root=client.createRoot(document.getElementById('root'));root.render(/*#__PURE__*/ // <React.StrictMode>
(0,jsx_runtime.jsx)(src_App,{})// </React.StrictMode>
...
/******/ })()
;
//# sourceMappingURL=main.dd0b4a82.js.map